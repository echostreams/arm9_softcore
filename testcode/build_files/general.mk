...
CPU       = arm7tdmi
OPTS      = -mcpu=$(CPU) $(THUMB_IW) -mapcs-frame -mapcs-stack-check
...
SPECS = -specs=nano.specs -specs=nosys.specs -Wl,--gc-sections

ifndef LD_SCRIPT_PATH
LD_OPTS   = $(OPTS) $(EFLAGS) $(SPECS) -nostartfiles -T $(LD_SCRIPT) -o $(NAME).elf -Wl,-Map=$(NAME).map,--cref
else
LD_OPTS   = $(OPTS) $(EFLAGS) $(SPECS) -nostartfiles -T $(LD_SCRIPT_PATH)/$(LD_SCRIPT) -o $(NAME).elf -Wl,-Map=$(NAME).map,--cref
endif
